...
var fileDescriptor_a0b84a42fa06f626 = []byte{
	...
	0x5c, 0x9a, 0x53, 0x02, 0x55, 0x0c, 0xe5, 0x19, 0xed, 0x60, 0xe4, 0xe2, 0x72, 0x4c, 0x49, 0x09,
	0x86, 0x58, 0x23, 0xa4, 0xc6, 0xc5, 0xec, 0x98, 0x92, 0x22, 0xc4, 0x07, 0xb1, 0x4f, 0x0f, 0x6a,
	0x8b, 0x14, 0x3f, 0x9c, 0x0f, 0x35, 0x4e, 0x9b, 0x8b, 0xc3, 0xb7, 0x34, 0xa7, 0x24, 0xb3, 0x20,
	0xa7, 0x92, 0xb0, 0x62, 0x2d, 0x2e, 0xf6, 0xe0, 0xd2, 0xa4, 0xa2, 0xc4, 0xe4, 0x12, 0xc2, 0x6a,
	0x35, 0xb9, 0xd8, 0x5c, 0x32, 0xcb, 0x32, 0x53, 0x52, 0x09, 0x2a, 0x4d, 0x62, 0x03, 0xf3, 0x8d,
	0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0x5d, 0x1d, 0x58, 0xb3, 0x24, 0x01, 0x00, 0x00,
}
...
type AddServiceClient interface {
	...
	Subract(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
...
func (c *addServiceClient) Subract(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.AddService/Subract", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AddServiceServer interface {
	...
	Subract(context.Context, *Request) (*Response, error)
...
func (*UnimplementedAddServiceServer) Subract(ctx context.Context, req *Request) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Subract not implemented")
}
...
func _AddService_Subract_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AddServiceServer).Subract(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.AddService/Subract",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AddServiceServer).Subract(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _AddService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Subract",
			Handler:    _AddService_Subract_Handler,
		},
		{
			MethodName: "Divide",
